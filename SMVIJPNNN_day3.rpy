...
label SMVIJ_day3:
    ...
    me "Вот и отлично."
    "Она медленно поднимает голову с моих колен и принимает сидячие положение."
    ...
    "Я смотрю на Леру, но она не даже не смотрит в мою сторону."
    ...
    "Зал взорвался апплодисментами, даже Лера и Кристина учавствуют в этом, вот только да Леры не дошло, что она сейчас должна быть здесь."
    ...
    "Я поднял руку с микрофоном в небо, вот только тищина стала ответом на мои действия."
    "Однако через несколько секунд зал сообразил, что надо делать."
    "Апплодисменты полились рекой, все начили свистеть и кричать."
    ...
    "Тут и Ольга Дмитриевна решила поучавствовать в интерактиве. И да, ей это было легче всех, ибо она сидит в первом ряду."
    ...
    "Зал начинает слегка хохатать, однако это делают не все, потому что многие просто находятся в шоке."
    me "Спасибо, Лера."
    ...
    "Лера начинает щикотать этого пионера."
    ...
    me "На этом моё выступление заканчивается, но я надеюсь на то, что мы еще увидимся, всем пока."
    "Зал встал и апплодировал мне стоя."
