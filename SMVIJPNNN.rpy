...
label SMVIJPNNN_label_1:
    ...
    if d1_Lera_diner_ploho:
        ...
        "Я передал ей будерброды, чтобы она поела по пути и мы держась за руки направились на пляж."
        scene ext_square_sunset with dissolve 
        $ renpy.pause (2)
        scene ext_path_sunset with dissolve
        $ renpy.pause (2)
    ...
    if d1_Lera_diner_ploho:
        ...
        "Присев на кровать, я стал пристально рассматиривать свои ноги."
        ...
        menu:
            "Пойти искать Леру":
                ...
                th "Что это с ней? {w}Что-то у неё с насторением под конец дня странное происходит."
                ...
                Ler_SM "Кстати, а где нащи вещи, которые мы с собой брали? {w}Я просто не выдержу неделю, как ты сказал, в джинсах по такой жаре."
