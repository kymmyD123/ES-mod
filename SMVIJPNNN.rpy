...
label SMVIJPNNN_label_1:
    ...
    "И тут мне пришла в голову мысль, что если я пойду и познакомлюсь с обычными пионерами про которых даже ничего не известно в оригинальной игре."
    ...
    th "Подружку?! Стоп, то есть она хочет сказать, что видит Леру?! Как это понимать?!"
    ...
    Vlr_SM "Нет, ребят, посижу тут, не хочу есть. {w}Приятного аппетита вам."
    ...
    Ler_SM "Да, ты прав, а я и не задумалась над этим."
