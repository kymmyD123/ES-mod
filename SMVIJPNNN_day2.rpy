...
label day2_musclub_SMVIJ:
    ...
    hide mi with dspr
    th "Такой скорости даже супергерои позавидовали бы."
    ...
    menu:
        "Послушать музыку":
            ...
            "Пальцы Мику скачат по клавишам, а её волнение ушло в раз."
            ...
            me "Спасибо за твое шикарное выступление для меня одного. Я бы остался еще побеседовать, но мне пора."
...
label day2_poisk_SMVIJ_mode2:
    ...
    if d2_SL_svidanka:
        ...
        "В далеке я увидел ту самую фигуру, которую забыть просто невозможно. Лера шла с Кристиной, которая несла какую-то корзину."
        ...
        "Славя всё идет рядом со мной и распрашивает меня о моей жизни."
        ...
        me "Тут так красиво."
        "Я не соврал. Это место очень красиво, даже не смотря на то, что видел его я кучу раз."
        ...
        sl "Ну что например?"
        me "Ну..."
        "Я впал в раздумия. А ведь это не так легко придумать занятие подобного рода."
        ...
        Ler_SM "Угу."
        "Лера промычала. Она постаралась вложить в этот звук как можно больше принебрежения и недоверия."
        ...
        me "Это я должен тебя спрашивать. Где ты слонялась весь день? Я тут себе оба логтя искусал, пока волновался за тебя. Телефона тут нет, позвонить некуда. Вожатая говорит, что ты на задании, а подробности раскрывать не хочет."
        ...
        extend " Ты забыла, что ты тут на правах гостя незванного? Ты, Лера, невидима! Она позвала только Кристину, а вот она уже ,в свою очередь, позвала тебя."
        ...
        Ler_SM "Сегодня быд тяжелый день. Спокойной ночи."
        me "Спокойной ночи."
        ...
        "Уже вечер, а Леры и Кристины всё еще не видно. Где же они черт бы их побрал?"
