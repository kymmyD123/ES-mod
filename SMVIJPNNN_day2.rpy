...
label day2_musclub_SMVIJ:
    ...
    show mi smile pioneer at center
    extend
    mi "Мой папа русский, а мама японка. У меня папа там что-то в Японии строит, вот так они и познакомились."
    ...
    me "Да... Спасибо."
# ЗДЕСЬ НАДО СДЕЛАТЬ ВЫБОР С МУЗЫКОЙ НА РОЯЛЕ. ПОТОМ ФЛАГ С ПЛАСТИНКОЙ И ИСПОЛЬЗОВАТЬ ЕГО В ХОРОШЕЙ КОНЦЕВКЕ МИКУУУ!!!!!
